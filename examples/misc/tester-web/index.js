...
(async () => {
    ...
    */
    ...
    // const { faustNode, dspMeta: { name } } = await createFaustNode(audioContext, "tester_expanded", FAUST_DSP_VOICES, true);
    const result = await createFaustNode(audioContext, "tester_expanded", FAUST_DSP_VOICES);
